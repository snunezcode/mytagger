...
zip -j -r artifacts/functions/lambda.api.zip artifacts/lambda.api/lambda_function.py

cd artifacts/lambda.api/ && zip -r ../functions/lambda.api.zip lambda_function.py